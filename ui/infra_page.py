...
def render_guide_page():
    ...
    <div class="step-box">
        ...
        데이터가 업로드되면 대시보드로 이동하여 우리 회사의 현재 건강 상태(위험군 비율, 주요 퇴사 원인 등)를 진단합니다.
    </div>
    <div class="step-box">
    ...
    with st.expander("Q. AI의 퇴사 예측은 어떤 원리로 이루어지나요?"):
        st.write("수많은 인사 데이터(나이, 근속년수, 워라밸, 월급, 야근 여부 등)를 바탕으로 학습된 머신러닝 알고리즘을 사용합니다. 특정 직원의 패턴이 과거 퇴사자들의 패턴과 얼마나 유사한지 확률(%)로 수치화하여 보여줍니다.")
