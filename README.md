...
| 공통 레이아웃 컴포넌트<br>dashboard 페이지<br>최적화 솔루션 페이지<br>전처리 및 모델링 | 퇴사 위험 예측 및 분석 페이지<br>직원 관리 및 수정 페이지<br> 맞춤형 시뮬레이션 페이지<br>DB | 핵심 인재 관리 페이지<br>DB<br>ERD | 로그인<br>회원가입<br>발표준비 | 모델링<br>데이터 전처리<br>발표준비 |
